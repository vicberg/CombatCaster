/* 
 * Version 0.1 Beta
 * Original by Victor B
 * Discord: Vic#5196
 * Roll20: https://app.roll20.net/users/3135709/victor-b
 * Github: https://github.com/vicberg/CombatMasterSpells
*/
var CombatCaster = CombatCaster || (function() {
    'use strict';
    ...
    script_name = 'CombatCaster',
    combatState = 'COMBATMASTERSPELLS',
...
//         }
	...
	commandHandler = function(cmdDetails,msg,restrict,who,playerID){
        ...
        if (cmdDetails.action == 'import') {
            importCombatCaster(cmdDetails.details.config)
        }
...
//*************************************************************************************************************
    sendMainMenu = function(who) {
        ...
        let listItems           = []
        let titleText           = 'CombatCaster Menu<span style="'+styles.version+'"> ('+version+')</span>'+'<span style='+styles.buttonRight+'>'+helpButton+'</span>'
    ...
    sendConfigMenu = function() {
		...
		let	resetHeaderText             = '<div style="'+styles.header+'">Reset CombatCaster</div>'	
...
on('ready',function() {
    ...
    // CombatCaster.CheckInstall();
    CombatCaster.RegisterEventHandlers();
